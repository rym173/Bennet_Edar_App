...
import 'package:bennet_eddar_cook/screens/YourOrders/treatedOrderItem.dart';
...
Future<List<OrderItem>> fetchOrders(String cookId) async {
  final response =
      await http.get(Uri.parse(getApiEndpointForCookTreatedOrders(cookId)));
...
class treatedOrdersPage extends StatefulWidget {
  final String cookId;

  treatedOrdersPage({required this.cookId});

  @override
  _treatedOrdersPageState createState() => _treatedOrdersPageState();
}

class _treatedOrdersPageState extends State<treatedOrdersPage> {
